...
export const TOOLS: ToolDefinition[] = [
  ...
  },
  {
    ...
    shortDescription: 'Cut and trim video clips with frame-accurate precision.',
    description: 'Trim MP4, WebM, and MOV videos directly in your browser. Set start and end points with interactive slider controls and export the cut clip instantly.',
    icon: 'Scissors',
    supportedFormats: ['video/mp4', 'video/webm', 'video/quicktime'],
    maxFileSizeMB: 200,
    engine: 'browser',
    isPopular: true,
    seoTitle: 'Video Trimmer Online — Cut Video Clips Fast | QuickVero',
    seoDescription: 'Cut and trim video clips online for free with QuickVero. Set start and end points with interactive preview directly in your browser.',
    keywords: ['video trimmer', 'cut video', 'trim mp4', 'clip video online'],
    features: ['Interactive video scrubber and timeline', 'Precise start and end timestamp sliders', '100% in-browser video processing'],
    howToSteps: [
      { step: 1, title: 'Upload video', description: 'Select an MP4, WebM, or MOV video.' },
      { step: 2, title: 'Set cut markers', description: 'Drag the start and end sliders to choose your segment.' },
      { step: 3, title: 'Download cut video', description: 'Click Cut & Download Video to save your trimmed clip.' }
    ],
    faqs: [
      { question: 'Is my video uploaded to a server?', answer: 'No, QuickVero trims your video locally inside your browser using HTML5 Canvas and MediaRecorder APIs.' }
    ]
  },
  {
    id: 'video-compressor',
